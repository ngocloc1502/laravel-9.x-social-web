...
<div class="graybg authorpage">
	<div class="container">
                ...
                <div class="card">
                    <div class="row m-0">
                        @if ($post->getImagesRelation->count() != 0)
                            @foreach ($post->getImagesRelation as $key => $item)
                                <figure class="figure">
                                    <img src="{{ asset('storage/images/'.$item->image) }}" id="{{ 'images-'.$key }}"class="rrounded mx-auto d-block" alt="..."> 
                                </figure>
                            @endforeach
                        @endif  
                    </div>						
                    <div class="card-block">
                        <div class="row">
                            @if ($post->getImagesRelation->count() == 0)
                                <h2 class="col-md-10 card-title" style="width: 1px; ">
                                    {{ $post->content }}
                                </h2>
                            @else
                                <h4 class="col-md-10 card-text">
                                    {{ $post->content }}
                                </h4>
                            @endif
                        ...
                        @foreach ($comments as $item)
                            <div class="row post-top-meta">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @if (Auth::id() === $item->user_id || Auth::user()->getRoles->where('id', 1)->count() == 1)
        ...
        <div class="row listrecent listrelated">
            @foreach ($article->where('get_images_relation_count', '>', 0)->take(3) as $post)
                <!-- begin post -->
                <div class="col-md-4">
                    <div class="card">
